...
if (isset($_POST['update_status'])) {
    ...
    $notifLink = "index.php?page=pengaduan&action=detail&id={$id_pengaduan}";
    $statusLabel = ['menunggu'=>'Ditunggu','diproses'=>'Diproses','selesai'=>'Selesai','ditolak'=>'Ditolak'];
    $label = $statusLabel[$status] ?? $status;
    buat_notifikasi((int)$p['user_id'], "Pengaduan $label", "Pengaduan '{$p['judul']}' telah $label oleh Admin.", $notifLink, "pengaduan_$status");
    
    alert('success', 'Status pengaduan berhasil diperbarui!');
    redirect('index.php?page=pengaduan');
}
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?page=pengaduan">Pengaduan</a></li>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page=pengaduan&action=detail&id=<?= $row['id'] ?>" class="text-decoration-none fw-semibold">
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="index.php?page=pengaduan&action=detail&id=<?= $row['id'] ?>" class="btn btn-sm btn-info text-white" title="Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="index.php?page=pengaduan&delete=1&id=<?= $row['id'] ?>" class="btn btn-sm btn-danger btn-delete" title="Hapus">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                ...
                <nav>
                    <ul class="pagination pagination-sm mb-0">
                        <?php if ($hal > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="?page=pengaduan&p=<?= $hal - 1 ?>&search=<?= $search ?>&status=<?= $filter_status ?>&kategori=<?= $filter_kategori ?>&ruangan=<?= $filter_ruangan ?>">
                        ...
                        <li class="page-item <?= $i === $hal ? 'active' : '' ?>">
                            <a class="page-link" href="?page=pengaduan&p=<?= $i ?>&search=<?= $search ?>&status=<?= $filter_status ?>&kategori=<?= $filter_kategori ?>&ruangan=<?= $filter_ruangan ?>"><?= $i ?></a>
                        </li>
                        <?php endfor; ?>
