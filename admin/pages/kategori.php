        ...
        <div class="glass-card h-100" data-aos="fade-up">
            <div class="d-flex justify-content-between align-items-start mb-3">
                ...
                <div class="d-flex gap-1">
                    <a href="index.php?page=kategori&action=edit&id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalKategori" onclick="editKategori(<?= $row['id'] ?>)">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="index.php?page=kategori&delete=1&id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-danger btn-delete">
...
<div class="modal fade" id="modalKategori" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content glass-card p-0">
            ...
            <form method="POST" action="index.php?page=kategori" enctype="multipart/form-data">
...
function editKategori(id) {
    fetch('pages/get_kategori.php?id=' + id)
        .then(res => res.json())
        .then(data => {
            ...
            document.querySelector('#modalKategori form').action = 'index.php?page=kategori&action=edit&id=' + id;
            // Update preview
...
document.getElementById('modalKategori').addEventListener('hidden.bs.modal', function () {
    ...
    document.querySelector('#modalKategori form').action = 'index.php?page=kategori';
});
