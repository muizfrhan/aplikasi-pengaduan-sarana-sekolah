...
if (isset($_POST['simpan'])) {
    ...
    echo '<script>Swal.fire({icon:"success",title:"Berhasil",text:"Profil berhasil diperbarui!"}).then(function(){window.location.href="index.php?page=profil";});</script>';
    exit;
}
...
<div class="row g-4">
    <div class="col-lg-4">
        <div class="glass-card text-center">
            ...
            <span class="badge bg-success mb-3">Guru</span>
