...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-size: 150px; font-weight: 800; background: linear-gradient(135deg, #EF4444, #F97316); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; margin-bottom: 10px; }
...
<body>
    <div class="error-page">
        ...
        <p class="error-text">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.</p>
