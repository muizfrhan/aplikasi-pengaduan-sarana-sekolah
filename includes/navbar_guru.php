<?php
$pageInfo = [
    'dashboard'       => ['icon' => 'fa-home',           'title' => 'Dashboard Guru'],
    'pengaduan'       => ['icon' => 'fa-clipboard-list', 'title' => 'Data Pengaduan'],
    'testimoni'       => ['icon' => 'fa-comment-dots',   'title' => 'Kelola Testimoni'],
    'pesan-kontak'    => ['icon' => 'fa-headset',        'title' => 'Pesan Kontak'],
    'laporan'         => ['icon' => 'fa-file-alt',       'title' => 'Laporan'],
    'export-template' => ['icon' => 'fa-file-export',    'title' => 'Template Export'],
    'profil'          => ['icon' => 'fa-user-cog',       'title' => 'Profil'],
];
$currentPage = $pageInfo[$page] ?? ['icon' => 'fa-home', 'title' => 'Dashboard Guru'];
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="page-indicator d-none d-md-flex align-items-center gap-2">
                    <span class="page-indicator-icon"><i class="fas <?= $currentPage['icon'] ?>"></i></span>
                    <span class="page-indicator-text"><?= $currentPage['title'] ?></span>
                </div>
            </div>
                            ...
                            <div class="dropdown-profile-header">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="dropdown-profile-info">
                                        ...
                                        <div class="dropdown-profile-role">Guru</div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="index.php?page=profil"><span class="dropdown-icon bg-primary-subtle"><i class="fas fa-user-cog"></i></span>Profil Saya</a></li>
                        <li><hr class="dropdown-divider"></li>
