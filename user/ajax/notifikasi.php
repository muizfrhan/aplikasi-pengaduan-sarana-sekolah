...
$unread = (int)fetch(query("SELECT COUNT(*) as c FROM notifications WHERE user_id = ? AND is_read = 0", [$userId]))['c'];

$sql = "SELECT id, judul, pesan, link, jenis, created_at FROM notifications WHERE user_id = ? ORDER BY id DESC LIMIT 20";
