...
if (isset($_POST['simpan'])) {
    ...
    execute("UPDATE users SET nama_lengkap=?, email=?, nis=?, kelas=?, no_hp=? WHERE id=?", 
        [$nama_lengkap, $email, $nis, $kelas, $no_hp, $_SESSION['user_id']]);
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="glass-card text-center">
                    ...
                    <span class="badge bg-success mb-3">User</span>
                    <div class="text-start">
                        ...
                        <div class="mb-2">
                            ...
                            <p class="fw-semibold mb-0"><?= $user['nis'] ?? '-' ?></p>
                        </div>
                        <div class="mb-2">
